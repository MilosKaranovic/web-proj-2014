...
<c:forEach var="uredjaj" items="${source}">
    ...
    <tr>
    	...
    	<td>
    		<c:set var="pocetak" scope="page" value="/WebShop/MasterServlet?poziv=izmenaUredjaja&naziv="/>
		...
		<td>
			<c:set var="naziv" scope="page" value="${uredjaj.value.naziv}"/>
			<c:set var="pocetak" scope="page" value="/WebShop/MasterServlet?poziv=brisiUredjaj&naziv="/>
    		<form action=${pocetak}${naziv} method="post">
...
PRETRAGA:
  <table  border=0>
    <tr>
    <form name="pretragaNaziv" action="/WebShop/MasterServlet?poziv=pretragaUredjaja" method="post">
   ...
   <tr>
    <form name="pretragaOpis" action="/WebShop/MasterServlet?poziv=pretragaUredjaja" method="post">
    ...
    <tr>
      ...
      <form name="pretragaKategorija" action="/WebShop/MasterServlet?poziv=pretragaUredjaja" method="post">
      	<td>
...
<a href="/WebShop/admin/uredjaji.jsp">Refresh</a>
</p>
</body>
</html>
